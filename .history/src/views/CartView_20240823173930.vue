<script setup>
    ...
    function deleteOrder(button, key, id) {
...
<template>
    <table border="1px" style="border-collapse: collapse;">
        ...
        <tbody id="tbody">
            <tr class="row-cart" v-if="f_check_length_cart" v-for="(value, key) in cart" :key="value.id">
                <td>{{ key + 1 }}</td>
                <td>{{ value.name }}</td>
                <td>{{ value.image }}</td>
                ...
                <td style="text-align: center;">
                    <span @click="deleteOrder(this, key, value.id)" class="material-symbols-outlined delete-btn">
                        delete
                    </span>
                </td>
            </tr>
