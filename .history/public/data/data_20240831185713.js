...
const getData = async (id = null) => {
    try {
        let url = 'http://localhost/Backend_Vuejs/api.php'
        if (id !== null) {
            url += id
        }
...
const addProduct = async () => {
    try {
        ...
        console.log('Adding product successfully!', res.data)
    } catch (error) {
        console.log(error);
    }
}
...
const deleteProduct = async (id) => {
    try {
        let url = 'http://localhost/Backend_Vuejs/api.php/delete'
        // url += id
        const res = await axios.delete(url)
        console.log('Deleted data successfully!', res.data)
    } catch (error) {
        console.log(error);
    }
}
